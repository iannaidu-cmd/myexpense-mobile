...
function IconBuilding() {
  return (
    <Svg width={26} height={26} viewBox="0 0 26 26">
      <Rect x="3" y="8" width="20" height="15" rx="2" fill="#E07A3A" opacity="0.15" stroke="#E07A3A" strokeWidth="1.8" />
      <Rect x="8" y="3" width="10" height="6" rx="1.5" fill="none" stroke="#E07A3A" strokeWidth="1.8" />
      <Rect x="7" y="13" width="4" height="4" rx="1" fill="#E07A3A" opacity="0.4" />
      <Rect x="15" y="13" width="4" height="4" rx="1" fill="#E07A3A" opacity="0.4" />
      <Rect x="10" y="18" width="6" height="5" rx="1" fill="#E07A3A" opacity="0.3" />
    </Svg>
  );
}
...
function IconLaptop() {
  return (
    <Svg width={26} height={26} viewBox="0 0 26 26">
      <Rect x="4" y="5" width="18" height="13" rx="2.5" fill="#006FFD" opacity="0.15" stroke="#006FFD" strokeWidth="1.8" />
      <Rect x="7" y="8" width="12" height="7" rx="1" fill="#006FFD" opacity="0.2" />
      <Rect x="8" y="9.5" width="7" height="1.5" rx=".75" fill="#006FFD" opacity="0.5" />
      <Rect x="8" y="12" width="5" height="1.5" rx=".75" fill="#006FFD" opacity="0.35" />
      <Path
        d="M2 19 Q2 18 4 18 L22 18 Q24 18 24 19 L24 20 Q24 21 22 21 L4 21 Q2 21 2 20 Z"
        fill="#006FFD" opacity="0.15" stroke="#006FFD" strokeWidth="1.5"
      />
    </Svg>
  );
}
...
function IconClipboard() {
  return (
    <Svg width={26} height={26} viewBox="0 0 26 26">
      <Rect x="4" y="5" width="18" height="20" rx="2.5" fill="#00A884" opacity="0.12" stroke="#00A884" strokeWidth="1.8" />
      <Rect x="9" y="2" width="8" height="5" rx="2" fill="none" stroke="#00A884" strokeWidth="1.8" />
      <Rect x="7" y="11" width="12" height="1.8" rx=".9" fill="#00A884" opacity="0.45" />
      <Rect x="7" y="14.5" width="9" height="1.8" rx=".9" fill="#00A884" opacity="0.3" />
      <Rect x="7" y="18" width="10" height="1.8" rx=".9" fill="#00A884" opacity="0.3" />
      <Polyline
        points="14,20 16,22 20,17"
        stroke="#00A884" strokeWidth="1.8"
...
// ── Option Card ────────────────────────────────────────────────────────────────
function OptionCard({ bgColor, icon, title, selected, onPress }: {
  bgColor: string;
...
const OPTIONS = [
  { id: 'sole',       bgColor: '#FFF3E8', icon: <IconBuilding />,  title: 'Sole Proprietor' },
  { id: 'freelancer', bgColor: '#EAF2FF', icon: <IconLaptop />,    title: 'Freelancer' },
  { id: 'contractor', bgColor: '#F0FBF8', icon: <IconClipboard />, title: 'Independent Contractor' },
];
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colour.white }}>
      <View style={{ flex: 1, paddingHorizontal: space.lg }}>
        ...
        <Text style={{ fontSize: 15, color: colour.textSub, lineHeight: 22, marginBottom: space.xl }}>
          This helps us apply the right SARS ITR12 rules and deduction categories for your situation.
        </Text>
        ...
        <View style={{ flexDirection: 'row', gap: space.md, marginBottom: space.md }}>
          ...
          >
            <Text style={{ fontSize: 17, fontWeight: '700', color: selected ? colour.white : colour.textSub }}>
