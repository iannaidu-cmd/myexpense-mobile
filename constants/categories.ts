...
export const CATEGORIES: Category[] = [
  { label: "Travel & Transport",       icon: "car.fill",              code: "S8(1)(b)",  deductible: true  },
  { label: "Home Office",              icon: "house.fill",            code: "S11(a)/S23(b)", deductible: true  },
  ...
  { label: "Meals & Entertainment",    icon: "fork.knife",            code: "S23(o)",    deductible: true, partialCap: 0.8 },
  ...
  { label: "Telephone & Internet",     icon: "phone.fill",            code: "S11(a)",    deductible: true  },
  { label: "Vehicle Expenses",         icon: "car.fill",              code: "S11(a)",    deductible: true  },
